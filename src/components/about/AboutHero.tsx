      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 animate-fade-in" style={{ animationDelay: "300ms" }}>
            <Link to="/contact">
              <Button size="lg" className="rounded-xl bg-white text-brand-blue hover:bg-white/90 shadow-lg hover:shadow-xl transition-all duration-300 px-8">
                Kontaktieren Sie uns
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <Link to="/auth?register=true">
              <Button size="lg" variant="outline" className="rounded-xl border-white text-white hover:bg-white/10 px-8">
                Jetzt registrieren
              </Button>
            </Link>
          </div>
