        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-soft p-4 border border-gray-100 animate-pulse">
                <div className="flex items-center">
                  ...
                  <p className="text-sm font-medium text-gray-800">
                    Seit 2025 im Dienst des Mittelstands
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="inline-flex items-center mb-4">
              ...
              <span className="ml-3 text-brand-blue font-medium text-sm uppercase tracking-wide">
                Unsere Vision
              </span>
            </div>

            <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-brand-blue to-brand-teal">
              Unsere Mission
            </h2>

            <p className="text-lg text-gray-700 mb-8">
              Connect.Now wurde mit einer klaren Vision gegründet: Die
              Unternehmensnachfolge in Deutschland zu revolutionieren und sie
              für alle Beteiligten effizienter, sicherer und erfolgreicher zu
              gestalten.
            </p>
                ...
                <CardContent className="p-6 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Wir schaffen perfekte Verbindungen zwischen Verkäufern und
                      Nachfolgern, damit Lebenswerke in den richtigen Händen
                      weiterleben können.
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="border-none shadow-soft bg-white hover:shadow-soft-lg transition-all duration-300 overflow-hidden group">
                <CardContent className="p-6 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Durch modernste Technologie und persönliche Betreuung
                      schaffen wir einen sicheren Rahmen für eine erfolgreiche
              ...
              <Card className="border-none shadow-soft bg-white hover:shadow-soft-lg transition-all duration-300 overflow-hidden group">
                <CardContent className="p-6 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Wir garantieren höchste Diskretion, Professionalität und
                      Sicherheit in jedem Schritt des Nachfolgeprozesses.
                    </p>
                  </div>
                </CardContent>
              </Card>
