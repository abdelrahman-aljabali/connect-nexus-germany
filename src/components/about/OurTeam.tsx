...
import { Linkedin, Mail, ChevronLeft, ChevronRight, Award, Briefcase, Users } from "lucide-react";
...
const OurTeam = () => {
  ...
  const membersPerView = window.innerWidth >= 1024 ? 3 : window.innerWidth >= 640 ? 2 : 1;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {visibleMembers.map((member, index) => (
              ...
              >
                ...
                <div className="bg-white rounded-2xl shadow-soft overflow-hidden group-hover:shadow-soft-lg transition-all duration-300 animate-fade-in h-full flex flex-col"
                ...
                >
                  ...
                  <div className="p-8 flex-grow flex flex-col">
                    ...
                    <p className="text-brand-teal font-medium mb-4 text-center">{member.role}</p>
