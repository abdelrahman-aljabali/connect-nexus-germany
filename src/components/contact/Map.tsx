      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center justify-center mb-6">
            <Navigation className="h-8 w-8 text-brand-teal mr-3" />
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-soft-lg animate-fade-in h-[400px] md:h-[500px]">
            ...
            ></iframe>
            <div className="absolute top-4 left-4 bg-white py-3 px-5 rounded-xl shadow-soft flex items-center">
              <div className="bg-brand-blue/10 p-2 rounded-lg mr-3">
                <Navigation className="h-5 w-5 text-brand-blue" />
              </div>
              <div>
                <div className="text-sm font-medium text-gray-900">Connect.Now</div>
