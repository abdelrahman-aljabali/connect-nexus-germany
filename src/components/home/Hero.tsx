        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900">
              Sichere Unternehmensnachfolge <span className="text-brand-blue">einfach</span> gemacht
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl">
              Connect.Now bringt Unternehmer, die ihr Geschäft übergeben möchten, 
              mit qualifizierten Nachfolgern zusammen – diskret, sicher und professionell.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/auth?type=seller">
                <Button size="lg" className="rounded-2xl bg-brand-blue hover:bg-brand-blue/90 text-white">
                  Unternehmen eintragen
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
              <Link to="/auth?type=buyer">
                <Button size="lg" variant="outline" className="rounded-2xl border-brand-blue text-brand-blue hover:bg-brand-blue/10">
          ...
          <div className="relative hidden lg:block animate-fade-in">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-lg p-4 border border-gray-100 max-w-xs">
              <div className="flex items-center space-x-2">
                <div className="h-3 w-3 bg-green-500 rounded-full"></div>
                <p className="text-sm font-medium">Über 500+ erfolgreiche Vermittlungen</p>
              </div>
            </div>
